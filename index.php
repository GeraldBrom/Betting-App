...
<body>
    ...
    <main class="main">
        ...
        <?php include 'sections/toc.php'; ?>
        <?php include 'sections/indian-premier-league.php'; ?>
        <?php include 'sections/ipl-app-download.php'; ?>
        <?php include 'sections/ipl-cricket-betting.php'; ?>
        <?php include 'sections/welcome-bonus.php'; ?>
