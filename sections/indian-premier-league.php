<section class="ipl-indian" id="indian-premier-league">
    <div class="container">
        ...
        <div class="ipl-indian__content">
            <h2 class="ipl-indian__title">Indian Premier League</h2>

            <div class="ipl-indian__slider swiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <p class="ipl-indian__text">
                            IPL or the Indian Premier League is the world's top men's T20 cricket league.
                            Organized by the BCCI, its first edition was held in 2008.
                            The latest edition of the league (2024) had 10 participating teams.
                            The games are held all over India in different cities.
                            Most of the world's top cricket players are seen in this exciting league.</p>
                    </div>
                    <div class="swiper-slide">
                        <p class="ipl-indian__text">
